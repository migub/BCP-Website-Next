  ...
  rows: [
    {
      ...
      content: (
        <p className="px-2 pb-2 font-light text-white">
          ...
          reliable manner. This is what the smart contract oracle does. Oracles
          are also needed to inform smart contracts about financial data, like
          interest rates. One of the main applications of oracles is currently
          the reliable creation of random numbers for gambling purposes, but
          Blockchain Presence aims to offer a much broader scope of
          informational input.
        </p>
      ),
    },
    ...
    },
    {
      ...
      content: (
        <p className="px-2 pb-2 font-light text-white">
          ...
          once the data has been sent by your sender of choice. Coding examples
          for the order & delivery process are provided on Github.
        </p>
      ),
    },
    {
      ...
      content: (
        <p className="px-2 pb-2 font-light text-white">
          Using the platform is free. However, as with any operation within the
          Ethereum network, the order function call and the delivery transaction
          will be executed only if sufficient gas is provided by your smart
          contract. We have designed the order & delivery process to keep these
          gas costs at the absolute minimum necessary.
        </p>
      ),
    },
    {
      ...
      content: (
        <p className="px-2 pb-2 font-light text-white">
          ...
          blockchain world. Another reason is that a sender might wish to ensure
          that data he feels responsible for is available for smart contracts.
          Finally, a sender may choose to charge fees on the information he
          provides.
        </p>
      ),
    },
